...
//サイトのトップページのURL
$site_top = "https://hyakuninisshu.blue/";

//管理者のメールアドレス ※メールを受け取るメールアドレス プロバイダーMAILやyahooMailを設定
$to = "pmed5585@yahoo.co.jp";

//送信元メールアドレス　ここはGmailでも可能（管理者宛て、及びユーザー宛メールの送信元メールアドレスです）
$from = "co.yuki.river@gmail.com";
...
$Referer_check_domain = "hyakuninisshu.blue";
...
$BccMail = "co.yuki.river@gmail.com";
...
$thanksPage = "https://hyakuninisshu.blue/";
...
Email:co.yuki.river@gmail.com
URL: https://hyakuninisshu.blue/
********************************************
...
/*　簡易版レスポンシブ用（必要最低限のみとしています。ブレークポイントも含め自由に設定して下さい）　*/
...
function postToMail($arr){
	...
	foreach($arr as $key => $val) {
		...
		if (version_compare(PHP_VERSION, '5.1.0', '<=')) {//PHP5.1.0以下の場合のみ実行
